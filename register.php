...
<div class="card card-center">
    <h2 style="text-align: center; margin-bottom: 25px; color: var(--mocha);">Join VeriTick</h2>
    <?php if ($error): ?> 
    ...
    <p style="text-align: center; margin-top: 25px; font-size: 0.95rem;" class="text-muted">
        Already have an account? <a href="login.php" style="color: var(--green); text-decoration: none; font-weight: 700;">Log in</a>
    </p>
</div>
</body>
</html>